package com.wsy.mp4recorderdemo.camera;
...
public class CameraHelper implements Camera.PreviewCallback {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                synchronized (this) {
                    ...
                    try {
                        Log.i(TAG, "run: " + (Looper.myLooper() == Looper.getMainLooper()));
    ...
    private int getCameraOri(int rotation) {
        ...
        if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            ...
            // info.orientation     rotation                intermediate    result

            // 270                  Surface.ROTATION_0      270             90
            // 270                  Surface.ROTATION_90     360             0
            // 270                  Surface.ROTATION_180    90              270
            // 270                  Surface.ROTATION_270    180             180

            // 90                  Surface.ROTATION_0       90              270
            // 90                  Surface.ROTATION_90      180             180
            // 90                  Surface.ROTATION_180     270             90
            // 90                  Surface.ROTATION_270     360             0
            ...
            // info.orientation     rotation                result

            // 90                   Surface.ROTATION_0      90
            // 90                   Surface.ROTATION_90     0
            // 90                   Surface.ROTATION_180    270
            // 90                   Surface.ROTATION_270    180

            // 0                    Surface.ROTATION_0      0
            // 0                    Surface.ROTATION_90     270
            // 0                    Surface.ROTATION_180    180
            // 0                    Surface.ROTATION_270    90

            // 180                    Surface.ROTATION_0      180
            // 180                    Surface.ROTATION_90     90
            // 180                    Surface.ROTATION_180    0
            // 180                    Surface.ROTATION_270    270


            result = (info.orientation - degrees + 360) % 360;
        }
        Log.i(TAG, "getCameraOri: " + mCameraId + " " + rotation + " " + result);
        return result;
    }
